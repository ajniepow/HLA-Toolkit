...
DSA2.0:
	...
	Note:
		...
		DB variables (server and DB name) for Fusion/Histotrac can be found in the settings or database menu for the respective application, or by contacting your database administrator. 
		{SQL Server} driver should suit most cases and not need to be changed. 
		API variables can be found in the UNOS developer portal for your institution: https://developer.unos.org/
